  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        "float-slow": { "0%, 100%": { transform: "translateY(0) rotate(0deg)" }, "50%": { transform: "translateY(-30px) rotate(3deg)" } },
      ...
      animation: {
        ...
        "fade-in-up": "fade-in-up 0.8s var(--transition-smooth)",
        "scale-in": "scale-in 0.5s var(--transition-spring)",
